...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, context) {
    ...
    var renderVN = function renderVN() {
      ...
      return (0, _vue.h)('div', {
        ref: refElem,
        class: ['vxe-textarea', className, (_a = {}, _a["size--".concat(vSize)] = vSize, _a['is--autosize'] = autosize, _a['is--disabled'] = disabled, _a['def--rows'] = !_xeUtils.default.eqNull(rows), _a['def--cols'] = !_xeUtils.default.eqNull(cols), _a)]
      }, [(0, _vue.h)('textarea', {
        ref: refTextarea,
