...
function transformModule(ast, moduleName, bundleInfo, options) {
    ...
    const exportedNamesDeclaration = (0, make_node_1.makeVariablesDeclaration)(exportedNames);
    const warppedStatements = topLevelStatements.flatMap(stmt => {
        if (stmt.type === "VariableDeclaration") {
            ...
            if (!exportedNameSet.has(name))
                return stmt;
            return (0, make_node_1.makeAssignmentStatement)((0, make_node_1.makeIdentifier)(name), {
                ...stmt,
    ...
    transformByType(warppedStatements, "CallExpression", (call) => {
        if (call.callee.type === "Import") {
            ...
            if (argument.type === "StringLiteral") {
                ...
                // Skip transform
                if (importedModuleName && !bundleInfo[importedModuleName].transformNeeded)
                    return call;
            }
            return (0, make_node_1.makeCallExpression)((0, make_node_1.makeMemberExpression)(call, "then"), [
                (0, make_node_1.makeArrowFunction)(["m"], [
                    (0, make_node_1.makeStatement)((0, make_node_1.makeAwaitExpression)((0, make_node_1.makeMemberExpression)("m", "__tla"))),
